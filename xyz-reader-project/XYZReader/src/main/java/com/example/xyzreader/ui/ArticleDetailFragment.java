...
import com.example.xyzreader.ui.FabBehavior;
...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCoordinatorLayout = (CoordinatorLayout)
                mRootView.findViewById(R.id.detail_fragment_layout);
        ...
        CollapsingToolbarLayout mCollapsingToolbar = (CollapsingToolbarLayout)
                mRootView.findViewById(R.id.collapse_toolbar);
        //this will change the display title text color.
        mCollapsingToolbar.setContentScrimColor(getResources().getColor(R.color.light_blue_500));
        mCollapsingToolbar.setExpandedTitleTextAppearance(R.style.expandedappbar);
        mCollapsingToolbar.setCollapsedTitleTextAppearance(R.style.collapsedappbar);

        mPhotoView = (ImageView) mRootView.findViewById(R.id.detail_photo);
